...
nitpick_ignore_regex = [
    # PySide isn't compatible with intersphinx without some fiddling
    # https://bugreports.qt.io/browse/PYSIDE-2215?gerritIssueType=IssueOnly
    (r"py:.*", r"PySide6\..*"),
]
