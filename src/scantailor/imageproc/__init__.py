...
from scantailor.imageproc.image_types import (
    BinaryImage,
    ColorImage,
    FloatImage,
    GrayImage,
...
__all__ = [
    ...
    "ColorImage",
    "FloatImage",
    ensure_binary.__name__,
    ensure_color.__name__,
    ensure_grayscale.__name__,
    invert_binary.__name__,
    is_binary.__name__,
    is_color.__name__,
    is_grayscale.__name__,
    # Analysis
    "DEFAULT_COARSE_STEP",
    "DEFAULT_MAX_ANGLE",
    SkewResult.__name__,
